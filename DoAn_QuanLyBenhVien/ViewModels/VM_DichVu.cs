...
{
    public class VM_DichVu : BaseViewModel
    {
        ...
        private List<DICHVU> _originalData = new List<DICHVU>();
        ...
        private void LoadData()
        {
            ...
            try
            {
                ...
                {
                    _originalData = db.DICHVUs.OrderBy(x => x.MA_DICHVU).ToList();
                    DanhSachDichVu = new ObservableCollection<DICHVU>(_originalData);
                }
            }
            catch (Exception ex)
            {
        ...
        private void ExecuteSearch()
        {
            ...
            else
            {
                ...
                var filtered = _originalData.Where(x => 
                    (x.TEN_DICHVU != null && x.TEN_DICHVU.ToLower().Contains(kw)) ||
                    (x.MA_DICHVU != null && x.MA_DICHVU.ToLower().Contains(kw))
                ).ToList();
                DanhSachDichVu = new ObservableCollection<DICHVU>(filtered);
            }
        }
    }
}
