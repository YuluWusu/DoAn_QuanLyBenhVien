...
{
    public class VM_DSNhanVien : BaseViewModel
    {
        // -------------------------------------------------------------------
        ...
        public ObservableCollection<string> ListChucVuFilter { get; set; }

        private string _selectedChucVuFilter = "Tất cả";
        public string SelectedChucVuFilter
        {
            get => _selectedChucVuFilter;
            set { _selectedChucVuFilter = value; OnPropertyChanged(); ExecuteSearch(); }
        }
        ...
        public VM_DSNhanVien()
        {
            ListChucVuFilter = new ObservableCollection<string> { "Tất cả", "Bác sĩ", "Admin", "Nhân viên" };
        ...
        private void ExecuteSearch()
        {
            ...
            if (SelectedChucVuFilter != "Tất cả")
            {
                filtered = filtered.Where(x => x.ChucVu == SelectedChucVuFilter);
            }

            ListNhanVien = new ObservableCollection<NHANVIEN>(filtered.ToList());
        }
    }
}
